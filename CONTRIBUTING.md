# Contributing to can-define-list
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-define-list) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-define-list, you can start by going to its [fork page](https://github.com/canjs/can-define-list/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-define-list
```
